...
<html>
    ...
    <body>
        ...
        <main style="margin-top:1px; margin-bottom:35px;">
            <div class="container">
                <div class="row">
                                ...
                                <g id="stars">
                                    ...
                                    <g id="circlesBig">
                                        ...
                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="588.977" cy="255.978" r="7.952"></circle>

                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="450.066" cy="320.259" r="7.952"></circle>

                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="168.303" cy="353.753" r="7.952"></circle>

                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="429.522" cy="201.185" r="7.952"></circle>

                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="200.67" cy="176.313" r="7.952"></circle>

                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="133.343" cy="477.014" r="7.952"></circle>

                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="283.521" cy="568.033" r="7.952"></circle>

                                        <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10"
                                                cx="413.618" cy="482.387" r="7.952"></circle>
                                    </g>
                                    <g id="circlesSmall">
                                        <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651"></circle>
                                        <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651"></circle>
                                        <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651"></circle>
                                        <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651"></circle>
                                        <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651"></circle>
                                        <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651"></circle>
                                        <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651"></circle>
                                    </g>
                                </g>
                                ...
                                C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
                                    ...
                                    <g id="head">
                                        ...
                                        <path id="headStripe" fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round"
                                              stroke-linejoin="round" stroke-miterlimit="10" d="
                                    M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246"></path>
                                    ...
                                    s33.181,12.591,38.725,16.498c2.387,1.682,3.461,4.668,2.705,7.488L380.857,346.164z"></path>
                                        ...
                                        278.436,375.599 383.003,264.076 364.393,251.618 264.807,364.928 				"></polygon>
                                        </g>
                                    </g>
                                </g>
                            </g>
