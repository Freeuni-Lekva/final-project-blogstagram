 ...
 * Generated at: 2021-08-09 17:42:01 UTC
...
public final class gearIconTemplate_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(isAdmin && !currentUserIsModerator){ 
      ...
      out.write("                    <div id=\"user_id\" style=\"display:none\">");
      out.print(user.getId());
      out.write("</div>\n");
      out.write("                       <button type=\"button\" class=\"btn btn-danger\" onclick=\"deleteMakeModer()\" id=\"makeModerButton\">Make Moderator</button>\n");
      out.write("                  </div>\n");
      out.write("                ");
      ...
      out.print(user.getId());
      out.write("</div>\n");
      out.write("                    <button type=\"button\" class=\"btn btn-danger\" onclick=\"deleteMakeUser()\" id=\"makeUserButton\">Take user privileges</button>\n");
      out.write("                  </div>\n");
      out.write("                ");
 }
      out.write("\n");
      ...
      out.write("    })\n");
      out.write("\n");
      out.write("    $(\"#makeModerButton\").click(function(e){\n");
      out.write("        const user_id = document.getElementById(\"user_id\").innerText;\n");
      out.write("        const OperationType = document.getElementById(\"OperationType\").innerText;\n");
      out.write("        $.post(\"/changeRole/user\",{user_id, OperationType}).then(response => {\n");
      out.write("            let responseJSON = JSON.parse(response);\n");
      out.write("            location.reload();\n");
      out.write("        })\n");
      out.write("    })\n");
      out.write("\n");
      out.write("    $(\"#makeUserButton\").click(function(e){\n");
      out.write("        const user_id = document.getElementById(\"user_id\").innerText;\n");
      out.write("        const OperationType = document.getElementById(\"OperationType\").innerText;\n");
      out.write("        $.post(\"/changeRole/user\",{user_id, OperationType}).then(response => {\n");
      out.write("            let responseJSON = JSON.parse(response);\n");
      ...
      out.write("    })\n");
      out.write("\n");
      out.write("    function deleteMakeUser() {\n");
      out.write("        var myobj = document.getElementById(\"makeUserButton\");\n");
      out.write("        myobj.innerHTML = \"Make Moderator\";\n");
      out.write("        myobj.setAttribute(\"id\",\"deleteMakeModer\");\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function deleteMakeModer() {\n");
      out.write("        var myobj = document.getElementById(\"makeModerButton\");\n");
      out.write("        myobj.innerHTML = \"Make User\";\n");
      out.write("        myobj.setAttribute(\"id\",\"deleteMakeUser\");\n");
      out.write("\n");
      out.write("    }\n");
      out.write("\n");
      out.write("</script>\n");
