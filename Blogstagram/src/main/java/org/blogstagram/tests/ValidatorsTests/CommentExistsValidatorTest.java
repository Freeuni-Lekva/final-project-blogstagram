...
import org.blogstagram.validators.CommentExistsValidator;
import org.junit.Test;

import java.sql.*;
import java.util.Random;

public class CommentExistsValidatorTest extends TestCase {
    Connection connection;
    UserDAO userDAO;
    private Random random = new Random();
    CommentDAO commentDAO;
    CommentExistsValidator commentValidator;
    ...
    protected void setUp() throws Exception {
        ...
        try {
            ...
            commentValidator = new CommentExistsValidator();
