            ...
            <% for(User user: users) { %>
                ...
                <div class="media border p-3">
                    ...
                    <div class="media-body mt-4">
                        <h4> <a href="/user/<%= user.getNickname() %>"> <%= user.getFirstname() %> <%= user.getLastname() %> </a> <small><i>Joined <%= user.getCreatedAt() %></i></small></h4>
                        <p><%= user.getPrivacy() == User.PRIVATE ? "Private" : "Public" %> account</p>
                    </div>
                </div>
            <% } %>
