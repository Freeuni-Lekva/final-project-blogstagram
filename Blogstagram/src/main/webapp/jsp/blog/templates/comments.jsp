...
<span class = "text-center bg-info text-white form-control"><h3 id = "likers-lst" >Likes: <span id = "count"><%= blog.getNumLikes() %></span></h3> <a href = "/blogstagram/likes?blog_id=<%= blog.getId() %>">See all</a></span>
