...
<div class="container">
    ...
    <div class="media border p-3">
        <img src="<%= liker.getImage() %>" alt="" class="mr-3 mt-3 rounded-circle" style="width:100px;height:100px;">
        <div class="media-body mt-4">
            <h4> <a href="/blogstagram/user/<%= liker.getNickname() %>"> <%= liker.getFirstname() %> <%= liker.getLastname() %> </a> <small><i> Date: <%= liker.getCreatedAt() %></i></small></h4>
        </div>
    </div>
    <% } %>
